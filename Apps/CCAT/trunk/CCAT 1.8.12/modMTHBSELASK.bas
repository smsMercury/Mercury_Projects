Attribute VB_Name = "modMTHBSELASK"
Private MSG_NAME As String
Private Const MSG_ID = 449

Private mrsData As Recordset
'
'
Public Sub Create_MTHBSELASK()
    MSG_NAME = guCurrent.sArchive & "_MTHBSELASK"
...
'        .Fields.Append .CreateField("PRI", dbDouble)
        .Fields.Append .CreateField("OnOff", dbLong)
...
End Sub
'
Public Sub Process_MTHBSELASK(uSig As DAS_MASTER_RECORD)
