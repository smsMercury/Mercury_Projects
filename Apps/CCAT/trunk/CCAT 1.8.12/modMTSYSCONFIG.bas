Attribute VB_Name = "modMTSYSCONFIG"
Private MSG_NAME As String
Private Const MSG_ID = 116

Private mrsData As Recordset
'
'
Public Sub Create_MTSYSCONFIG()
    MSG_NAME = guCurrent.sArchive & "_MTSYSCONFIG"
...
End Sub
'
Public Sub Process_MTSYSCONFIG(uSig As DAS_MASTER_RECORD)
