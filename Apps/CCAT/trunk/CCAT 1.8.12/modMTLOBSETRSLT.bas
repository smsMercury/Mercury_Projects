Attribute VB_Name = "modMTLOBSETRSLT"
Private MSG_NAME As String
Private Const MSG_ID = 60

Private mrsData As Recordset
'
'
Public Sub Create_MTLOBSETRSLT()
    MSG_NAME = guCurrent.sArchive & "_MTLOBSETRSLT"
...
End Sub
'
Public Sub Process_MTLOBSETRSLT(uSig As DAS_MASTER_RECORD)
