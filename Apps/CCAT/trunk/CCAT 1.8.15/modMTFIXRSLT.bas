Attribute VB_Name = "modMTFIXRSLT"
Private MSG_NAME As String
Private Const MSG_ID = 48

Private mrsData As Recordset
'
'
Public Sub Create_MTFIXRSLT()
    MSG_NAME = guCurrent.sArchive & "_MTFIXRSLT"
...
'        .Fields.Append .CreateField("PRI", dbDouble)
        .Fields.Append .CreateField("FixType", dbLong)
...
End Sub
'
Public Sub Process_MTFIXRSLT(uSig As DAS_MASTER_RECORD)
