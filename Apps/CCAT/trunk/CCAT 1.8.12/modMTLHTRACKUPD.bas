Attribute VB_Name = "modMTLHTRACKUPD"
Private MSG_NAME As String
Private Const MSG_ID = 484

Private mrsData As Recordset
'
'
Public Sub Create_MTLHTRACKCUPD()
    MSG_NAME = guCurrent.sArchive & "_MTLHTRACKCUPD"
...
End Sub
'
Public Sub Process_MTLHTRACKCUPD(uSig As DAS_MASTER_RECORD)

    '
    '
    Create_MTLHTRACKCUPD
