Attribute VB_Name = "modMTSIGUPD"
Private MSG_NAME As String
Private Const MSG_ID = 19

Private mrsData As Recordset
'
'
Public Sub Create_MTSIGUPD()
    MSG_NAME = guCurrent.sArchive & "_MTSIGUPD"
...
End Sub
'
Public Sub Process_MTSIGUPD(uSig As DAS_MASTER_RECORD)
