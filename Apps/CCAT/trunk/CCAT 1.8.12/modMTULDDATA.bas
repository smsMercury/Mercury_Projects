Attribute VB_Name = "modMTULDDATA"
Private MSG_NAME As String
Private Const MSG_ID = 50

Private mrsData As Recordset
'
'
Public Sub Create_MTULDDATA()
    MSG_NAME = guCurrent.sArchive & "_MTULDDATA"
...
End Sub
'
Public Sub Process_MTULDDATA(uSig As DAS_MASTER_RECORD)
