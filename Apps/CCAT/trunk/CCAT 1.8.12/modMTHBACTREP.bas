...
Public Sub Create_MTHBACTREP()
    MSG_NAME = guCurrent.sArchive & "_MTHBACTREP"
...
End Sub
'
Public Sub Process_MTHBACTREP(uSig As DAS_MASTER_RECORD)
