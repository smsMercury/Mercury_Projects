Attribute VB_Name = "modMTDFALARM"
Private MSG_NAME As String
Private Const MSG_ID = 3328

Private mrsData As Recordset
'
'
Public Sub Create_MTDFALARM()
    MSG_NAME = guCurrent.sArchive & "_MTDFALARM"
...
'        .Fields.Append .CreateField("PRI", dbDouble)
        ...
        .Fields.Append .CreateField("Num_Freqs", dbLong)
...
End Sub
'
Public Sub Process_MTDFALARM(uSig As DAS_MASTER_RECORD)
