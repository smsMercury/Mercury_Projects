Attribute VB_Name = "modMTNAVREP"
Private MSG_NAME As String
Private Const MSG_ID = 53

Private mrsData As Recordset
'
'
Public Sub Create_MTNAVREP()
    MSG_NAME = guCurrent.sArchive & "_MTNAVREP"
...
'        .Fields.Append .CreateField("PRI", dbDouble)
        .Fields.Append .CreateField("Wow", dbLong)
...
End Sub
'
Public Sub Process_MTNAVREP(uSig As DAS_MASTER_RECORD)
