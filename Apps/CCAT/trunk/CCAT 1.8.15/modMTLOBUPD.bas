Attribute VB_Name = "modMTLOBUPD"
Private MSG_NAME As String
Private Const MSG_ID = 49

Private mrsData As Recordset
'
'
Public Sub Create_MTLOBUPD()
    MSG_NAME = guCurrent.sArchive & "_MTLOBUPD"
...
End Sub
'
Public Sub Process_MTLOBUPD(uSig As DAS_MASTER_RECORD)
