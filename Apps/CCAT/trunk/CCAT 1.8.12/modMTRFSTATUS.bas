Attribute VB_Name = "modMTRFSTATUS"
Private MSG_NAME As String
Private Const MSG_ID = 2308

Private mrsData As Recordset
'
'
Public Sub Create_MTRFSTATUS()
    MSG_NAME = guCurrent.sArchive & "_MTRFSTATUS"
...
End Sub
'
Public Sub Process_MTRFSTATUS(uSig As DAS_MASTER_RECORD)
