Attribute VB_Name = "modMTHBGSUPSTAT"
Private MSG_NAME As String
Private Const MSG_ID = 123

Private mrsData As Recordset
'
'
Public Sub Create_MTHBGSUPSTAT()
    MSG_NAME = guCurrent.sArchive & "_MTHBGSUPSTAT"
...
End Sub
'
Public Sub Process_MTHBGSUPSTAT(uSig As DAS_MASTER_RECORD)
