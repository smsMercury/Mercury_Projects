Attribute VB_Name = "modMTSETACQSMODE"
Private MSG_NAME As String
Private Const MSG_ID = 29

Private mrsData As Recordset
'
'
Public Sub Create_MTSETACQSMODE()
    MSG_NAME = guCurrent.sArchive & "_MTSETACQSMODE"
...
End Sub
'
Public Sub Process_MTSETACQSMODE(uSig As DAS_MASTER_RECORD)

    '
    '
    Create_MTSETACQSMODE
