Attribute VB_Name = "modMTLOBRSLT"
Private MSG_NAME As String
Private Const MSG_ID = 58

Private mrsData As Recordset
'
'
Public Sub Create_MTLOBRSLT()
    MSG_NAME = guCurrent.sArchive & "_MTLOBRSLT"
...
End Sub
'
Public Sub Process_MTLOBRSLT(uSig As DAS_MASTER_RECORD)
