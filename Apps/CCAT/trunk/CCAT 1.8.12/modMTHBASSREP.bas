Attribute VB_Name = "modMTHBASSREP"
Private MSG_NAME As String
Private Const MSG_ID = 92

Private mrsData As Recordset
'
'
Public Sub Create_MTHBASSREP()
    MSG_NAME = guCurrent.sArchive & "_MTHBASSREP"
...
'        .Fields.Append .CreateField("PRI", dbDouble)
        .Fields.Append .CreateField("AssocChan", dbLong)
...
End Sub
'
Public Sub Process_MTHBASSREP(uSig As DAS_MASTER_RECORD)
