Attribute VB_Name = "modMTPLANAREA"
Private MSG_NAME As String
Private Const MSG_ID = 423

Private mrsData As Recordset
'
'
Public Sub Create_MTPLANAREA()
    MSG_NAME = guCurrent.sArchive & "_MTPLANAREA"
...
End Sub
'
Public Sub Process_MTPLANAREA(uSig As DAS_MASTER_RECORD)
