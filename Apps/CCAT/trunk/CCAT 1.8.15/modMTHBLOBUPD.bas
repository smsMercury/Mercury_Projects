Attribute VB_Name = "modMTHBLOBUPD"
Private MSG_NAME As String
Private Const MSG_ID = 566

Private mrsData As Recordset
'
'
Public Sub Create_MTHBLOBUPD()
    MSG_NAME = guCurrent.sArchive & "_MTHBLOBUPD"
...
End Sub
'
Public Sub Process_MTHBLOBUPD(uSig As DAS_MASTER_RECORD)
