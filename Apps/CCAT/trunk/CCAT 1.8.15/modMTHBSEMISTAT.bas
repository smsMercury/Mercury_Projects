Attribute VB_Name = "modMTHBSEMISTAT"
Private MSG_NAME As String
Private Const MSG_ID = 96

Private mrsData As Recordset
'
'
Public Sub Create_MTHBSEMISTAT()
    MSG_NAME = guCurrent.sArchive & "_MTHBSEMISTAT"
...
End Sub
'
Public Sub Process_MTHBSEMISTAT(uSig As DAS_MASTER_RECORD)
