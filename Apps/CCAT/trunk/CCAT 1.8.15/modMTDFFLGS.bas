Attribute VB_Name = "modMTDFFLGS"
Private MSG_NAME As String
Private Const MSG_ID = 52

Private mrsData As Recordset
'
'
Public Sub Create_MTDFFLGS()
    MSG_NAME = guCurrent.sArchive & "_MTDFFLGS"
...
'        .Fields.Append .CreateField("PRI", dbDouble)
        .Fields.Append .CreateField("LobIntersectPma", dbLong)
        .Fields.Append .CreateField("GoodQuality", dbLong)
...
End Sub
'
Public Sub Process_MTDFFLGS(uSig As DAS_MASTER_RECORD)
...
'        .Fields("PRI") = uSig.dPRI
        .Fields("LobIntersectPma") = uSig.lStatus
        .Fields("GoodQuality") = uSig.lTag
