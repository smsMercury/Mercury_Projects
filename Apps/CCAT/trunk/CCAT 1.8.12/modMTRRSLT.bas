Attribute VB_Name = "modMTRRSLT"
Private MSG_NAME As String
Private Const MSG_ID = 2569

Private mrsData As Recordset
'
'
Public Sub Create_MTRRSLT()
    MSG_NAME = guCurrent.sArchive & "_MTRRSLT"
...
End Sub
'
Public Sub Process_MTRRSLT(uSig As DAS_MASTER_RECORD)
