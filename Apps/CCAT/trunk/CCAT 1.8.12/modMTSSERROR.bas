Attribute VB_Name = "modMTSSERROR"
Private MSG_NAME As String
Private Const MSG_ID = 113

Private mrsData As Recordset
'
'
Public Sub Create_MTSSERROR()
    MSG_NAME = guCurrent.sArchive & "_MTSSERROR"
...
'        .Fields.Append .CreateField("Signal_ID", dbLong)
        ...
        .Fields.Append .CreateField("Severity", dbLong)
        .Fields.Append .CreateField("Category", dbLong)
...
End Sub
'
Public Sub Process_MTSSERROR(uSig As DAS_MASTER_RECORD)
...
'        .Fields("Signal_ID") = uSig.lSignal_ID
        ...
        .Fields("Severity") = uSig.lStatus
        .Fields("Category") = uSig.lTag
        .Fields("ErrorCode") = uSig.lFlag
