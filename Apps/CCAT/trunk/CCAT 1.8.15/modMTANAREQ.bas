Attribute VB_Name = "modMTANAREQ"
Private MSG_NAME As String
Private Const MSG_ID = 45

Private mrsData As Recordset
'
'
Public Sub Create_MTANAREQ()
    MSG_NAME = guCurrent.sArchive & "_MTANAREQ"
...
End Sub
'
Public Sub Process_MTANAREQ(uSig As DAS_MASTER_RECORD)
