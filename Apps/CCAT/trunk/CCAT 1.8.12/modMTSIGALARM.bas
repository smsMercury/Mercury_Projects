...
Public Sub Create_MTSIGALARM()
    MSG_NAME = guCurrent.sArchive & "_MTSIGALARM"
...
'        .Fields.Append .CreateField("Signal_ID", dbLong)
        ...
        .Fields.Append .CreateField("Amplitude", dbDouble)
...
End Sub
'
Public Sub Process_MTSIGALARM(uSig As DAS_MASTER_RECORD)
...
'        .Fields("Signal_ID") = uSig.lSignal_ID
        ...
        .Fields("Amplitude") = uSig.dPRI
        .Fields("RfStatus") = uSig.lStatus
'        .Fields("Tag") = uSig.lTag
        .Fields("SignalStatus") = uSig.lFlag
