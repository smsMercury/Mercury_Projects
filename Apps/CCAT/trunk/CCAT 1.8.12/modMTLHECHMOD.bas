Attribute VB_Name = "modMTLHECHMOD"
Private MSG_NAME As String
Private Const MSG_ID = 76

Private mrsData As Recordset
'
'
Public Sub Create_MTLHECHMOD()
    MSG_NAME = guCurrent.sArchive & "_MTLHECHMOD"
...
'        .Fields.Append .CreateField("PRI", dbDouble)
        .Fields.Append .CreateField("EchType", dbLong)
        .Fields.Append .CreateField("Echid", dbLong)
        .Fields.Append .CreateField("LmbEchJamPri", dbLong)
...
End Sub
'
Public Sub Process_MTLHECHMOD(uSig As DAS_MASTER_RECORD)
...
'        .Fields("PRI") = uSig.dPRI
        .Fields("EchType") = uSig.lStatus
        .Fields("Echid") = uSig.lTag
        .Fields("LmbEchJamPri") = uSig.lFlag
