Attribute VB_Name = "modMTDEFPMA"
Private MSG_NAME As String
Private Const MSG_ID = 51

Private mrsData As Recordset
'
'
Public Sub Create_MTDEFPMA()
    MSG_NAME = guCurrent.sArchive & "_MTDEFPMA"
...
End Sub
'
Public Sub Process_MTDEFPMA(uSig As DAS_MASTER_RECORD)
