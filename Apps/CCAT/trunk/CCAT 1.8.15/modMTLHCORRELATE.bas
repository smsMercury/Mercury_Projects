Attribute VB_Name = "modMTLHCORRELATE"
Private MSG_NAME As String
Private Const MSG_ID = 345

Private mrsData As Recordset
'
'
Public Sub Create_MTLHCORRELATE()
    MSG_NAME = guCurrent.sArchive & "_MTLHCORRELATE"
...
End Sub
'
Public Sub Process_MTLHCORRELATE(uSig As DAS_MASTER_RECORD)

    '
    '
    Create_MTLHCORRELATE
