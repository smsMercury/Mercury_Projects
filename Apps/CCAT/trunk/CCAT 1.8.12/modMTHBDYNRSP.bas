...
Private Const MSG_ID = 94

Private mrsData As Recordset
'
'
Public Sub Create_MTHBDYNRSP()
    MSG_NAME = guCurrent.sArchive & "_MTHBDYNRSP"
...
'        .Fields("PRI") = uSig.dPRI
        .Fields("Response") = uSig.lStatus
        .Fields("OnList") = uSig.lTag
'        .Fields("Flag") = uSig.lFlag
...
'        .Fields("XY") = uSig.dXY
'        .Fields("YY") = uSig.dYY
        .Fields("HBOPT") = uSig.sSupplemental
        .Update
    End With
End Sub
