...
Private Const MSG_ID = 434

Private mrsData As Recordset
'
'
Public Sub Create_MTTGTLISTUPD()
    MSG_NAME = guCurrent.sArchive & "_MTTGTLISTUPD"
    ...
    With ptblNew
        ...
        .Fields.Append .CreateField("Other_Data", dbText, 50)
    End With
    guCurrent.DB.TableDefs.Append ptblNew
End Sub
'
Public Sub Process_MTTGTLISTUPD(uSig As DAS_MASTER_RECORD)
