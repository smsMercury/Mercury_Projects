Attribute VB_Name = "modMTENVSTAT"
Private MSG_NAME As String
Private Const MSG_ID = 26

Private mrsData As Recordset
'
'
Public Sub Create_MTENVSTAT()
    MSG_NAME = guCurrent.sArchive & "_MTENVSTAT"
...
End Sub
'
Public Sub Process_MTENVSTAT(uSig As DAS_MASTER_RECORD)
