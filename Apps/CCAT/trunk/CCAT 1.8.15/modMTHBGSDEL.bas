Attribute VB_Name = "modMTHBGSDEL"
Private MSG_NAME As String
Private Const MSG_ID = 124

Private mrsData As Recordset
'
'
Public Sub Create_MTHBGSDEL()
    MSG_NAME = guCurrent.sArchive & "_MTHBGSDEL"
...
End Sub
'
Public Sub Process_MTHBGSDEL(uSig As DAS_MASTER_RECORD)
