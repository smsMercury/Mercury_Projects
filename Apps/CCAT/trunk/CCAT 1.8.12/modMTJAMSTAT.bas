Attribute VB_Name = "modMTJAMSTAT"
Private MSG_NAME As String
Private Const MSG_ID = 35

Private mrsData As Recordset
'
'
Public Sub Create_MTJAMSTAT()
    MSG_NAME = guCurrent.sArchive & "_MTJAMSTAT"
...
'        .Fields.Append .CreateField("PRI", dbDouble)
        .Fields.Append .CreateField("JamStatus", dbLong)
...
End Sub
'
Public Sub Process_MTJAMSTAT(uSig As DAS_MASTER_RECORD)
