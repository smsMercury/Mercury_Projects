Attribute VB_Name = "modMTHBSELJAM"
Private MSG_NAME As String
Private Const MSG_ID = 450

Private mrsData As Recordset
'
'
Public Sub Create_MTHBSELJAM()
    MSG_NAME = guCurrent.sArchive & "_MTHBSELJAM"
...
End Sub
'
Public Sub Process_MTHBSELJAM(uSig As DAS_MASTER_RECORD)
