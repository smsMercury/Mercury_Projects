Attribute VB_Name = "modMTLHTRACKREP"
Private MSG_NAME As String
Private Const MSG_ID = 98

Private mrsData As Recordset
'
'
Public Sub Create_MTLHTRACKREP()
    MSG_NAME = guCurrent.sArchive & "_MTLHTRACKREP"
    ...
    With ptblNew
        ...
        .Fields.Append .CreateField("Track_ID", dbLong)
...
End Sub
'
Public Sub Process_MTLHTRACKREP(uSig As DAS_MASTER_RECORD)
    ...
    With mrsData
        ...
        .Fields("Track_ID") = uSig.lTarget_ID
