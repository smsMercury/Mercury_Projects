Attribute VB_Name = "modMTHBXMTRSTAT"
Private MSG_NAME As String
Private Const MSG_ID = 97

Private mrsData As Recordset
'
'
Public Sub Create_MTHBXMTRSTAT()
    MSG_NAME = guCurrent.sArchive & "_MTHBXMTRSTAT"
...
End Sub
'
Public Sub Process_MTHBXMTRSTAT(uSig As DAS_MASTER_RECORD)
