...
'
'
Public Sub Create_MTHBGSREP()
    MSG_NAME = guCurrent.sArchive & "_MTHBGSREP"
...
End Sub
'
Public Sub Process_MTHBGSREP(uSig As DAS_MASTER_RECORD)
