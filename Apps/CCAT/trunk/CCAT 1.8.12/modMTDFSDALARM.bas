Attribute VB_Name = "modMTDFSDALARM"
Private MSG_NAME As String
Private Const MSG_ID = 3329

Private mrsData As Recordset
'
'
Public Sub Create_MTDFSDALARM()
    MSG_NAME = guCurrent.sArchive & "_MTDFSDALARM"
...
End Sub
'
Public Sub Process_MTDFSDALARM(uSig As DAS_MASTER_RECORD)
